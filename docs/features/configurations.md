...
This file is located in the root of your SD card or `/atmosphere/config/` folder and a default template can be found inside the `/atmosphere/config_templates/` folder.
